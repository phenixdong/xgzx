  ...
  <div>     
    <div>
        ...
        <div class="searchHeader" style="height: 50px;" > 
          ...
          <el-col :span="8" style="text-align: right; vertical-align: middle;
            ...
            <div style="float: right; line-height: 50px;">
              <el-button type="primary" icon="el-icon-search" size="medium" @click="getBulkBuyGroupsList">查询</el-button>
      ...
      <el-table :data="groupsList.records" stripe style="width: 100%" >
        <el-table-column prop="groupName" label="群名" min-width="15%" align="center" >
          <template slot-scope="scope">
            <span style="line-height: 50px; ">{{scope.row.groupName}}</span>
          </template>
        </el-table-column>
...
export default {
  ...
  methods: {
    resetQuery() {
      this.queryParams.groups.groupName = '';
      this.queryParams.createTimeRange = [];
      this.getBulkBuyGroupsList();
    },
    ...
    getBulkBuyGroupsList() {
      console.log("getBulkBuyGroupsList param " + JSON.stringify(this.queryParams));
      this.$fetch.getBulkBuyGroupsList(this.queryParams).then((resp) => {
        console.log("getBulkBuyGroupsList resp " + JSON.stringify(resp));
        if ("1" == resp.returnCode) {
