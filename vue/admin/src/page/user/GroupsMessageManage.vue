<template>  
  <div>     
    <div>
        ...
        <div class="searchHeader" style="height: 50px;" > 
          <el-col :span="16" style="text-align: left; vertical-align: middle;
            ...
            <div style="float: left; line-height: 50px; ">
              ...
              <div style=" display: inline-block;">
                <el-input v-model="queryParams.groups.groupName" style="" placeholder=""
          ...
          <el-col :span="8" style="text-align: right; vertical-align: middle;
            ...
            <div style="float: right; line-height: 50px;">
              <el-button type="primary" icon="el-icon-search" size="medium" @click="getMessageList">查询</el-button>
      ...
      <el-table :data="messageList.records" stripe style="width: 100%" 
        >
        ...
        <el-table-column prop="message" label="消息内容" min-width="30%" align="center"></el-table-column>
        <el-table-column prop="createTime" label="发布时间" min-width="15%" align="center"></el-table-column>
        <!--
        <el-table-column prop="groupId" label="操作" min-width="5%" align="center">
          <template slot-scope="scope">
    ...
    <div style="float: right; margin-top: 5px; ">
      <el-pagination background layout="total, prev, pager, next, jumper" :page-size="5"
        :total="messageList.total" :current-page="queryParams.page.current" 
...
export default {
  ...
  methods: {
    ...
    getMessageList() {
      console.log("getSendMessageList param " + JSON.stringify(this.queryParams));
      this.$fetch.getSendMessageList(this.queryParams).then((resp) => {
        console.log("getSendMessageList resp " + JSON.stringify(resp));
        if ("1" == resp.returnCode) {
          this.messageList = JSON.parse(JSON.stringify(resp.data));
        } else {
